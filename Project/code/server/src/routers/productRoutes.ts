...
class ProductRoutes {
    ...
    initRoutes() {
        ...
        this.router.post(
            ...
            body("category").isString().isLength({ min : 1}).isIn(["Smartphone", "Laptop", "Appliance"]),
            body("quantity").isInt({ min : 1 }),
            body("details").optional().isString(),
            body("sellingPrice").isFloat({ gt : 0.0 }),
            body("arrivalDate").optional().isString().isDate({format: "YYYY-MM-DD"}),
        ...
        this.router.patch(
            ...
            body("quantity").isInt({ min : 1 }),
            body("changeDate").optional().isString().isDate({format: "YYYY-MM-DD"}),
            this.errorHandler.validateRequest,
            this.authenticator.isLoggedIn,
            this.authenticator.isAdminOrManager,
        ...
        this.router.patch(
            ...
            param("model").isString().isLength({ min : 1}),
            body("quantity").isInt({ min : 1 }),
            body("sellingDate").optional().isString().isDate({format: "YYYY-MM-DD"}),
            this.errorHandler.validateRequest,
            this.authenticator.isLoggedIn,
            this.authenticator.isAdminOrManager,
